...
const Card = () => {
  return (
    <div className='h-full flex p-2 '>
      <div className='flex bg-zinc-500 flex-col h-[400px] w-[400px] max-w-sm rounded overflow-hidden mb-3 shadow-lg'>
      <div className='h-[200px] w-auto'>
         <img src='https://images.unsplash.com/photo-1526379095098-d400fd0bf935?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cHl0aG9ufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'/>
      </div>
      <div className='flex flex-col h-auto w-auto bg-zinc-50'>
        <div className=' h-[100px] flex items-center mt-4 text-xl font-bold hover:text-sky-400'>100 Days of Code: The Complete Python Pro Bootcamp for 2023</div>
        ...
        <div className='text-gray-500 font-bold text-base mb-1'>Laurence Svekis</div>
        <div class="flex items-center">
          ...
          <p class="ml-2 text-sm font-medium text-zinc-700/100 dark:text-gray-400">4 out of 5</p>
        </div>
      </div>
    </div>                                                                         
    </div>
